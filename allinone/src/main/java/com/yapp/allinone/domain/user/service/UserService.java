package com.yapp.allinone.domain.user.service;
...
import com.yapp.allinone.domain.user.persistence.command.handler.ProfileMessageCommandHandler;
import com.yapp.allinone.domain.user.persistence.command.handler.UserCommandHandler;
import com.yapp.allinone.domain.user.persistence.query.handler.ProfileMessageQueryHandler;
