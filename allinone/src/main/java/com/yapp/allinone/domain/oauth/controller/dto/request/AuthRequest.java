package com.yapp.allinone.domain.oauth.controller.dto.request;
...
public class AuthRequest {
    ...
    public static class Kakao extends AuthRequest implements AuthInfoProvider<KakaoDetail> {
        ...
        @Override
        public KakaoDetail detail() {
            return new KakaoDetail(accessToken, refreshToken);
        }
    }
    ...
    public static class Apple extends AuthRequest implements AuthInfoProvider<AppleDetail> {
        ...
        @Override
        public AppleDetail detail() {
            return new AppleDetail(identityToken, authorizationCode, userId);
        }
    }
