package com.yapp.supporter.entity.user.entity;
...
import com.yapp.supporter.entity.user.entity.element.Authority;
import com.yapp.supporter.entity.user.entity.element.OAuthInfos;
...
public class User extends BaseEntity {
    ...
    public void patchNickname(Long orderedId, String newNickname) {
        this.profileInfo.patchNickname(orderedId, newNickname);
    }
