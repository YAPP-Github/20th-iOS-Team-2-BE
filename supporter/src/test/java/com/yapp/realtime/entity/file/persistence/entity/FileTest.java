package com.yapp.realtime.entity.file.persistence.entity;
...
class FileTest {
    ...
    void createEntity_photo() {
        ...
        File 사진파일 = File.photoFile(링크, null, LocalDateTime.now(), null);
    ...
    @Test
    void modifyDate() {
        LocalDateTime 변경할_날짜 = LocalDateTime.of(LocalDate.of(2022, 8, 8), LocalTime.of(20, 10));
